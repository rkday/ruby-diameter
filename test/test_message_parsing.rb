...
describe 'Message parsing', 'Parsing a CER' do
  ...
  it 'can be parsed' do
    ...
    msg.avp_by_name('Firmware-Revision').uint32.must_equal 10_200
  ...
  it 'serialises back to its original form' do
    ...
    msg.to_wire
      ...
      .must_equal bytes.force_encoding('ASCII-8BIT')
  end
...
describe 'Message parsing', 'Parsing a MAR' do
  ...
  it 'can be parsed' do
    ...
    msg.request.must_equal true
    msg
      .avp_by_name('SIP-Auth-Data-Item')
      .inner_avp('SIP-Authentication-Scheme')
      .octet_string.must_equal 'Unknown'
  end
